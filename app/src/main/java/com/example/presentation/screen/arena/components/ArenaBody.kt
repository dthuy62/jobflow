...
import com.example.presentation.component.NeoButton
import com.example.presentation.component.NeoCard
import com.example.presentation.screen.arena.ArenaBody as ArenaBodyState
import com.example.presentation.screen.arena.ArenaUiIntent
...
private fun TaskList(
    tasks: List<com.example.domain.model.TaskDare>,
    onIntent: (ArenaUiIntent) -> Unit,
    modifier: Modifier = Modifier
) {
    LazyColumn(
